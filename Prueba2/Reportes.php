    ...
    <div class="contenedor-header">
        <header>
            ...
            <nav id="nav" class="navegador">
                <ul class="menu">
                    <li><a href="Alertas.php" onclick="seleccionar()" class="texto">ALERTAS</a></li>
                    ...
                    if ($stmt->rowCount() > 0) {
                        echo "<div id='resultados'><table border='1'>
                                <thead>
                                    <tr>
                                        ...
                                        <th>Fecha</th>
                                        <th>Descripción</th>
                                        <th>Estado</th> <!-- Columna modificada -->
                                    </tr>
                                </thead>
                                <tbody>";
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo "<tr>
                                    ...
                                    <td>{$estado}</td> <!-- Mostrar el estado correspondiente -->
                                </tr>";
                        }
